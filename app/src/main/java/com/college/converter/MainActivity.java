...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i("MainActivity", "onCreate() method starts.");
        ...
        Log.i("MainActivity", "onCreate() method exit.");
    }

    public void convertCurrency(View view) {
        Log.i("MainActivity", "convertCurrency() method starts.");
        ...
        Log.i("MainActivity", "convertCurrency() method exit.");
    }
}
